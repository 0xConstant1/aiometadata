...
## [1.24.0](https://github.com/0xConstant1/aiometadata/compare/v1.23.5...v1.24.0) (2026-01-24)


### Features

* add  metadata (itemCount, author) for all MDBList catalog imports and display ([9634c4e](https://github.com/0xConstant1/aiometadata/commit/9634c4e7dbee2c200fd6995b2369092df5da1aef))
* add 0 cast members option ([fbbd6bc](https://github.com/0xConstant1/aiometadata/commit/fbbd6bcbe9844954d64d161cc9cc2fc1e432cfe1))
* add Calendar support for kitsu, mal, anilist, anidb, tmdb, tvdb and tvmaze ids ([4db6628](https://github.com/0xConstant1/aiometadata/commit/4db662872fad260cbb1952bd5d3bed7d69470a85))
* Add configurable days ahead for Trakt airing soon catalog ([275e5c9](https://github.com/0xConstant1/aiometadata/commit/275e5c9812b9a7dc5b14495c14b04999da1081a7))
* add Criterion Channel streaming provider ([0cd3794](https://github.com/0xConstant1/aiometadata/commit/0cd3794bb5a940cd7a2f6ee51d0bf815e5b658ea))
* add Criterion Channel streaming provider ([7f16c68](https://github.com/0xConstant1/aiometadata/commit/7f16c6801530665a1e844865fae8b3a2913f23ab))
* add DISABLE_METRICS env var to disable metrics collection ([71c044f](https://github.com/0xConstant1/aiometadata/commit/71c044ff73d72835418c187213350a9f4e951f21))
* add Gemini-specific proxy support (GEMINI_HTTP_PROXY/GEMINI_HTTPS_PROXY) ([7579caf](https://github.com/0xConstant1/aiometadata/commit/7579cafbcd4fd514d9d1262803e8bb87f3ab3c95))
* add HIDIVE as streaming provider ([8e17731](https://github.com/0xConstant1/aiometadata/commit/8e17731bebeaeb42b47e9c359fc577dbc8dff905))
* add IMDb ID search support to TMDB, TVDB, and TVMaze ([753bd84](https://github.com/0xConstant1/aiometadata/commit/753bd847a08366cef1393b9f23f4ac411abb6fa0))
* add MDBList top list import ([50abe0e](https://github.com/0xConstant1/aiometadata/commit/50abe0e921fa794ea24265464c168e87a4bb75da))
* Add MDBList Up Next catalog integration ([3d86bbf](https://github.com/0xConstant1/aiometadata/commit/3d86bbf845c90897aa48d85a332915aa57362da4))
* add more providers ([7bf97b9](https://github.com/0xConstant1/aiometadata/commit/7bf97b976411b602e09395573ef81922a62ffab1))
* add option to choose between proxying or not ratings posters via aiometadata ([eefd151](https://github.com/0xConstant1/aiometadata/commit/eefd1519148c613842d16b07b569a5e661fb0ceb))
* add polling to dashboard for admin users ([8bd38ff](https://github.com/0xConstant1/aiometadata/commit/8bd38fff3436265032bcdbe7785bb0149901f5a8))
* add polling to dashboard for admin users ([f199521](https://github.com/0xConstant1/aiometadata/commit/f19952163b0b5b2ede8c551eba29e5d9b085b255))
* add quick add functionality ([7ced45c](https://github.com/0xConstant1/aiometadata/commit/7ced45cb06159bd742f5c050bbf60726d89c661b))
* Add Rate Me button as genre in meta pages ([fa2c218](https://github.com/0xConstant1/aiometadata/commit/fa2c218451297c6c5ebe18cdbcca1a6c99bfee43))
* Add rating page with multi-service support (Trakt, AniList, MDBList) ([228ada5](https://github.com/0xConstant1/aiometadata/commit/228ada57585b006e362b3b4873f98c07aec6bc97))
* Add sort options for TMDB year and language catalogs ([ca0ac4c](https://github.com/0xConstant1/aiometadata/commit/ca0ac4c8be792e8d6b6c3aa49d97c712bab25b80))
* add sort options to streaming catalogs ([ed4cdb3](https://github.com/0xConstant1/aiometadata/commit/ed4cdb39b6574f6e5d4a074138d4b9faa86d7350))
* Add TMDB Lists integration ([510c17b](https://github.com/0xConstant1/aiometadata/commit/510c17bfaedc75faa2c5db77bed5e9705b7780aa))
* add TMDB rate limit tracking with x-ratelimit-remaining support ([ed40415](https://github.com/0xConstant1/aiometadata/commit/ed40415e7d1a3e9181b7bb21f6e2846701f9e275))
* add TMDB release date fetching for anime movies ([fbbd6bc](https://github.com/0xConstant1/aiometadata/commit/fbbd6bcbe9844954d64d161cc9cc2fc1e432cfe1))
* add TMDB top rated and airing today catalogs ([2fc0ffb](https://github.com/0xConstant1/aiometadata/commit/2fc0ffba83ae307d0473cf44c2b9d525dad2d983))
* add Top Poster API integration for rating posters ([4cf583a](https://github.com/0xConstant1/aiometadata/commit/4cf583ab1a1273529b10c8c780dcaba506a27adc))
* add Trakt search ([b327237](https://github.com/0xConstant1/aiometadata/commit/b327237a043e892c6261d06cd7e2e5bec261e687))
* **anilist:** Add AniList trending anime catalog ([a8df749](https://github.com/0xConstant1/aiometadata/commit/a8df749c6873d94639a6ae741fcc8c7c0c13f95f))
* **catalogs:** add airing today catalog with origin country filter ([2fc0ffb](https://github.com/0xConstant1/aiometadata/commit/2fc0ffba83ae307d0473cf44c2b9d525dad2d983))
* **catalogs:** Add per-catalog randomization controls ([9ac3d89](https://github.com/0xConstant1/aiometadata/commit/9ac3d89b33bcfd07be7715d19ed17b2f068a2448))
* **catalogs:** add top rated movies and TV catalogs ([2fc0ffb](https://github.com/0xConstant1/aiometadata/commit/2fc0ffba83ae307d0473cf44c2b9d525dad2d983))
* **catalogs:** Add TVMaze daily schedule catalog ([15e928b](https://github.com/0xConstant1/aiometadata/commit/15e928b0c00342f6772def0bc473e6ef2c6a7776))
* Complete Trakt integration with all catalog types and optimizations ([e9eca39](https://github.com/0xConstant1/aiometadata/commit/e9eca39c7cdcb963f2374454fb9b7c32504dbab3))
* **custom-manifest:** Add proxy endpoint for Docker network manifest URLs ([9083e12](https://github.com/0xConstant1/aiometadata/commit/9083e12c4bb2f842df30d3874747e9a86e8d344e))
* **dashboard:** add ability to lock dashboard from public completely ([b73933c](https://github.com/0xConstant1/aiometadata/commit/b73933c21b4155d7b765ddeadec5341c6c4dfd8f))
* enrich episodes with IMDb data while preserving original IDs ([d24f13d](https://github.com/0xConstant1/aiometadata/commit/d24f13d0952b8a033dfe9548bfc4b1a79012c9ef))
* **episodes:** add Top Poster API support for episode thumbnails ([4cf583a](https://github.com/0xConstant1/aiometadata/commit/4cf583ab1a1273529b10c8c780dcaba506a27adc))
* **getManifest:** extend TMDB year catalog range from 20 years to 1900-present ([f55575e](https://github.com/0xConstant1/aiometadata/commit/f55575ea298cb94c7529e97837b1c859938a8125))
* implement gemini client, tweak prompt, improve perf ([e0074ad](https://github.com/0xConstant1/aiometadata/commit/e0074ad438588bb107ec46cd0be5aa07fd795a36))
* implement gemini search ([d15e10d](https://github.com/0xConstant1/aiometadata/commit/d15e10d78ed1bf010b1539f7de20be9883ee62d8))
* **kitsu:** enrich meta with tmdb info for consistent thumbnails and ep title/overview ([6170037](https://github.com/0xConstant1/aiometadata/commit/617003700cbcbb05affdb8fd692a04c4159cf8a4))
* **letterboxd:** Add letterboxd integration with list/watchlist url import support ([47d0464](https://github.com/0xConstant1/aiometadata/commit/47d0464d55dd58a8dd7a7b0be4ded5bba269e43a))
* **manifest:** add unwatched_ ID prefix ([a14d8e3](https://github.com/0xConstant1/aiometadata/commit/a14d8e3fbabcde7cd1426465355da805d8e8d206))
* **manifest:** allow logo override via ADDON_LOGO_URL env var ([790bf62](https://github.com/0xConstant1/aiometadata/commit/790bf62d38ff455377cd512de502f0cbf9bd7297))
* **mdblist:** add support for external lists ([cca3bd2](https://github.com/0xConstant1/aiometadata/commit/cca3bd2b4b50fcafc7089ec2c20a2ad94d4cc08a))
* merge tmdb art requests and deduplicate in-flight ([322f08d](https://github.com/0xConstant1/aiometadata/commit/322f08d68587b58f1721a5d0e0a58dde66f6c2c9))
* prevent marking watch status repeatedly ([0888bdb](https://github.com/0xConstant1/aiometadata/commit/0888bdb163221693f828c440ecda2ee22301d0ee))
* prevent marking watch status repeatedly ([56755fe](https://github.com/0xConstant1/aiometadata/commit/56755fe9f1aa1639a69bcf6453d2031bcc08dd5f))
* proxy frontend MDBList calls through backend rate limiter ([bfd1278](https://github.com/0xConstant1/aiometadata/commit/bfd1278659202bfdeac2ac2b9f4d1e84e43fce97))
* proxy frontend MDBList calls through backend rate limiter ([553cea2](https://github.com/0xConstant1/aiometadata/commit/553cea200995943ff2ed6c537bbb816f2193aecb))
* **rate me:** only add stream resource when rate me is activated ([38a2824](https://github.com/0xConstant1/aiometadata/commit/38a282444e205fd3ad1d098018ee193d547e6cf8))
* remove cinemeta fallback from imdb ratings fetcher ([28bfbbc](https://github.com/0xConstant1/aiometadata/commit/28bfbbc42c3c2b74697e9380cab3b7da930a9991))
* remove cinemeta fallback from imdb ratings fetcher ([c3fe45c](https://github.com/0xConstant1/aiometadata/commit/c3fe45c91f56e4eb98ccb7f21b4ce936a0f97d44))
* revamp dash ([f552aab](https://github.com/0xConstant1/aiometadata/commit/f552aabf7676a2d2b417ef8888239b1c463c4dce))
* revamp Error Management in dashboard ([4821f94](https://github.com/0xConstant1/aiometadata/commit/4821f94ec909ba7106312c2e74cce9820c12dc52))
* revamp Error Management in dashboard ([a730932](https://github.com/0xConstant1/aiometadata/commit/a730932befcc0c97350acba390c4c10720ae1884))
* revamp Maintenance Tasks, Provider Status & System Health, in dashboard ([4bf6c92](https://github.com/0xConstant1/aiometadata/commit/4bf6c92723c364a34cec2db4ae5756bc5abdd38d))
* **search:** add option to filter digital releases for searches only ([67f2ada](https://github.com/0xConstant1/aiometadata/commit/67f2adaa7f293fea85b5e55d4d74f9cf91a9d7af))
* **search:** Make AI search sortable and bump number of results to 20. ([f604a7e](https://github.com/0xConstant1/aiometadata/commit/f604a7e8c72be2da5162e42ac8dbcc894de2ded8))
* separate people search from title search for tmdb/trakt/tvdb ([2956fbf](https://github.com/0xConstant1/aiometadata/commit/2956fbf06c1593b5386e63147d2229b3d473591b))
* **settings:** add timezone configuration ([a14d8e3](https://github.com/0xConstant1/aiometadata/commit/a14d8e3fbabcde7cd1426465355da805d8e8d206))
* simkl integration ([59e5aa8](https://github.com/0xConstant1/aiometadata/commit/59e5aa835d86cd8220cd23fdedaa0e25afb60525))
* **simkl:** implement local pagination for watchlists and date_from sync ([9c366fa](https://github.com/0xConstant1/aiometadata/commit/9c366fa2161f9eee42c0482ddbe1d2f60f1a5bdc))
* **simkl:** improve watchlist support, ID filtering, and performance ([fa2edaf](https://github.com/0xConstant1/aiometadata/commit/fa2edaf9adbd9afdee48caf13997771ec813cd0e))
* **simkl:** make SIMKL_ACTIVITIES_TTL configurable ([c15b5d1](https://github.com/0xConstant1/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* start implementing AL tracking and catalogs ([14f0b4c](https://github.com/0xConstant1/aiometadata/commit/14f0b4cd6d9a1651bb854aac976c8dc4d882fbb1))
* start implementing mdblist watch status ([c391f88](https://github.com/0xConstant1/aiometadata/commit/c391f8848943dc16e9c3abeedc99d72f47ed4ed5))
* support blur endpoint for TOP Poster API ([fc6143a](https://github.com/0xConstant1/aiometadata/commit/fc6143a556dd983672c87e798a5f8721d88a9c6c))
* support blur endpoint for TOP Poster API ([424c127](https://github.com/0xConstant1/aiometadata/commit/424c1271eef3a13e057337035c77f8778b935100))
* **trakt up next:** add show poster toggle, cache key support, and Kitsu pagination fix ([a66ce63](https://github.com/0xConstant1/aiometadata/commit/a66ce63bc847f8fdcb1a4b93e366fd3a0bfdbbdc))
* **trakt:** add Airing Soon calendar catalog ([a14d8e3](https://github.com/0xConstant1/aiometadata/commit/a14d8e3fbabcde7cd1426465355da805d8e8d206))
* **trakt:** add My Recently Aired and Airing Soon catalogs with timezone support ([a14d8e3](https://github.com/0xConstant1/aiometadata/commit/a14d8e3fbabcde7cd1426465355da805d8e8d206))
* **trakt:** add My Recently Aired catalog ([a14d8e3](https://github.com/0xConstant1/aiometadata/commit/a14d8e3fbabcde7cd1426465355da805d8e8d206))
* **trakt:** Add trakt trending/popular movies/shows catalogs ([911f4a1](https://github.com/0xConstant1/aiometadata/commit/911f4a1d679f6528a93f9b70a9086d5561e0b22f))
* **trakt:** enhance custom lists with split option ([a14d8e3](https://github.com/0xConstant1/aiometadata/commit/a14d8e3fbabcde7cd1426465355da805d8e8d206))
* **ui:** Add auto-detect page size for custom manifests and optimize logging ([3777115](https://github.com/0xConstant1/aiometadata/commit/3777115c9d07647807ae236601dbc1ab7c61fb39))
* **ui:** enable Enter key submission in Header login form ([887f727](https://github.com/0xConstant1/aiometadata/commit/887f7273328eddfc44202f36a31b627ffa8a450c))
* **ui:** enable Enter key submission in Header login form ([8b03b0b](https://github.com/0xConstant1/aiometadata/commit/8b03b0bbf35fabe963dee992e40af0a4eea77538))
* **ui:** Track Kitsu search performance and improve nav ([01f66aa](https://github.com/0xConstant1/aiometadata/commit/01f66aa95a92d056bd6d9a8cdacb1d8fb5fafd90))


### Bug Fixes

* Add cache integrity checks and improve catalog warmer stats tracking ([a979caa](https://github.com/0xConstant1/aiometadata/commit/a979caa7f111fefeead0c28ff773a307a0ccd52c))
* add media.kitsu.app to allowed domains and increase blur intensity ([1477dce](https://github.com/0xConstant1/aiometadata/commit/1477dce279ea74146c7afa4059467f2cc89253f2))
* add missing func for oAuth token updates ([e4dc777](https://github.com/0xConstant1/aiometadata/commit/e4dc777034e2f22e42e5f99b506c1065a682102f))
* add null checks for TMDB API responses to prevent fallback issues ([571448e](https://github.com/0xConstant1/aiometadata/commit/571448e270928a4b694ef5ef8a17f71e07e90eae))
* add version prefix to component cache keys to prevent stale data ([ee11fe6](https://github.com/0xConstant1/aiometadata/commit/ee11fe693f3a0006988c412685cf001d32348851))
* address load trending lists error ([1963bae](https://github.com/0xConstant1/aiometadata/commit/1963bae6bb35aed1af186f0b199ad26f272c28ef))
* address TUN bug, enhance cache efficiency ([5fe3880](https://github.com/0xConstant1/aiometadata/commit/5fe3880d0660d5edfe5067c2c0418cf66f7be295))
* allow guests to disconnect from trakt ([97f76c1](https://github.com/0xConstant1/aiometadata/commit/97f76c176fa18ed92087fbe509d31e01982828b4))
* allow guests to disconnect from trakt ([c26980a](https://github.com/0xConstant1/aiometadata/commit/c26980ae8675789f90527c7ad2324a5f54ae4b2f))
* **anime art:** use the same art for catalog and meta even when use imdb id for MAL catalogs/search ([0375ccf](https://github.com/0xConstant1/aiometadata/commit/0375ccfb1a795167936574c74c749a1dbde9c809))
* **Anime mapping:** Update TVDB ID property name from thetvdb_id to tvdb_id to match upstream mapping changes ([44c2dff](https://github.com/0xConstant1/aiometadata/commit/44c2dffe95ecff9434a3dc83b61cb0a5b290aefc))
* **anime meta & fanart:** fix self-inflicted initialization issue and re apply langugage selection logic to fanart ([af1b8ec](https://github.com/0xConstant1/aiometadata/commit/af1b8ec459c498681087a7124a2bf71413e9dd16))
* **anime movie:** adapt ids to new anime movie id mapping ([0ca12cc](https://github.com/0xConstant1/aiometadata/commit/0ca12cc5832f5c50662ccf73b78cba101d1c4ada))
* apply digital release filter to Trakt/MDBList lists with type 'all' ([cd7d8c6](https://github.com/0xConstant1/aiometadata/commit/cd7d8c69117ba53260d9aca01483fb24a91a7b71))
* **art:** RPDB handling and improve error resilience ([eafe942](https://github.com/0xConstant1/aiometadata/commit/eafe9422ab0d23e62bfdd1afbc013fb2b8b757ec))
* **auth:** move TMDB authentication flow to frontend ([2fc0ffb](https://github.com/0xConstant1/aiometadata/commit/2fc0ffba83ae307d0473cf44c2b9d525dad2d983))
* **cache:** add auto cleanup of old meta cache keys on version change ([a2ae76b](https://github.com/0xConstant1/aiometadata/commit/a2ae76b8012eb942ba0a096fe5b01cc913216c35))
* **cache:** ensure rpdbEnabled is always boolean in catalog cache keys ([9cd0601](https://github.com/0xConstant1/aiometadata/commit/9cd06011b5798f217857f6f306d2ac02c86a82d6))
* **cache:** fix cache key mismatch in meta wrap smart by aligning animeIdProvider logic ([c4571e4](https://github.com/0xConstant1/aiometadata/commit/c4571e44444fa1fa54379d63638faa8b79358f7e))
* **cache:** Handle cache key correctly for anime id provider when using imdb id for anime ([36453f3](https://github.com/0xConstant1/aiometadata/commit/36453f391c1be15dbf122cbdb103cc61dc938dec))
* **cache:** hash config in cache keys to avoid generating big string ([a2ae76b](https://github.com/0xConstant1/aiometadata/commit/a2ae76b8012eb942ba0a096fe5b01cc913216c35))
* **cache:** Track meta cache hits correctly and prevent double-counting misses ([4b59363](https://github.com/0xConstant1/aiometadata/commit/4b5936368aaaee14cfbd61037c0b52680008450e))
* **cast credits:** add option to let the user force latin cast name when using a non EN lang for TMDB meta ([9963ad5](https://github.com/0xConstant1/aiometadata/commit/9963ad5cad744ffe22ddd3a3794d5299c37aa8dc))
* **catalog-warmer:** update Simkl pageSize handling for watchlists ([3acc908](https://github.com/0xConstant1/aiometadata/commit/3acc9083f247d3a2d746ab2a04886f05e992de76))
* clean logs ([0fa7c74](https://github.com/0xConstant1/aiometadata/commit/0fa7c74c94b53ef31cab4a612cfef5b073b43687))
* clean logs ([0401077](https://github.com/0xConstant1/aiometadata/commit/04010770c13034fdb92eb668b4294576ad29db43))
* **cleanup:** update version cleanup regex for semver tags ([c15b5d1](https://github.com/0xConstant1/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* **config:** safe SCAN-based deletion for meta cache clearing to avoid callstack/KEYS issues ([86efcce](https://github.com/0xConstant1/aiometadata/commit/86efcce6fd39070ddbc5ac2cad1b5ae928d99d28))
* correct manifest.json fields to match spec ([03bc6ba](https://github.com/0xConstant1/aiometadata/commit/03bc6ba8a518e91948ef4374702d7736fba0fa88)), closes [#132](https://github.com/0xConstant1/aiometadata/issues/132)
* correct type issue when setting specific display types like streaming provider name ([bb0b265](https://github.com/0xConstant1/aiometadata/commit/bb0b265ed77ea08aab13868435b015cf513983cf))
* **cors:** add global CORS middleware to ensure all responses include CORS headers ([f7e6880](https://github.com/0xConstant1/aiometadata/commit/f7e68807e14fdaa568c227366e5f3f1484929d45))
* **custom catalogs:** allow configuring page size for imports to fix pagination for addons that use less than 100 as page size ([683205b](https://github.com/0xConstant1/aiometadata/commit/683205ba45109bfc8047d333a9b1f636a4515468))
* decouple html blurb from user configs ([2ed1aeb](https://github.com/0xConstant1/aiometadata/commit/2ed1aeb3100667c1f37846d16cbcf1a86bfb1e11))
* decouple html blurb from user configs ([fdedabb](https://github.com/0xConstant1/aiometadata/commit/fdedabb779179356540ce08449f2b3ddec75cdba))
* enable necessary metrics for Ratings page functionality ([95e63bd](https://github.com/0xConstant1/aiometadata/commit/95e63bd5cb7f2b8cf60baf38481777098641717e))
* enable necessary metrics for Ratings page functionality ([7a6a419](https://github.com/0xConstant1/aiometadata/commit/7a6a419762a6b50ba5dee4ed7862f86d16d15926))
* ensure logo fallback works in catalog endpoint and fix MDBList unified watchlist parsing ([eb277b0](https://github.com/0xConstant1/aiometadata/commit/eb277b04a1348ac4c25bd9232b60c0242bdbd988))
* ensure MDBList API key test uses rate limiter ([0e40ba4](https://github.com/0xConstant1/aiometadata/commit/0e40ba4e73368ba23edef9a747a52e20b7494f27))
* filter out spam entries from TMDB airing today catalog ([591d265](https://github.com/0xConstant1/aiometadata/commit/591d265460f4cbe74d5c0f5505da62b749227cf4))
* finetune person's search logic further ([#99](https://github.com/0xConstant1/aiometadata/issues/99)) ([5df4cc6](https://github.com/0xConstant1/aiometadata/commit/5df4cc6a29a2d8adb43ba611f48aefcd404b9e39))
* finish implementing automatic Trakt token refresh ([3e7c3e9](https://github.com/0xConstant1/aiometadata/commit/3e7c3e9b25ef1bc423eee234f9fa80c802fb8a66))
* Fixed issue with IMDb ratings not being correctly retrieved for tmdb series. ([1c85701](https://github.com/0xConstant1/aiometadata/commit/1c8570136be4226f53e54ad5886dd095e2d84d38))
* **frontend:** Conditionally display addon password for user deletion ([fc87102](https://github.com/0xConstant1/aiometadata/commit/fc87102aad83c53d5517929a8782d27d02292ab8))
* gemini validation ([fd7a09f](https://github.com/0xConstant1/aiometadata/commit/fd7a09f83695d6fa652ac574f1b482665e5fbf16))
* gemini validation ([9c28306](https://github.com/0xConstant1/aiometadata/commit/9c2830662ea3f5ffc6a83d7624c72d0ad14f1b32))
* Hide Episode Spoilers now works with TOP API ([88dea98](https://github.com/0xConstant1/aiometadata/commit/88dea98abe4d2bbae878fb526b693c1491a27338))
* id mapper parsing ([5f3f590](https://github.com/0xConstant1/aiometadata/commit/5f3f5909d7dfaf402670212f9f352013691b7bd3))
* id mapper parsing ([edd5973](https://github.com/0xConstant1/aiometadata/commit/edd59730e0d3ab87ba389ae21c81f14be605e6ad))
* **imdb meta:** show age rating for imdb meta ([3ce2ba7](https://github.com/0xConstant1/aiometadata/commit/3ce2ba77c44e1f7d44a0c4c64a173692f13fae5e))
* **import:** use full replacement for config import ([6031911](https://github.com/0xConstant1/aiometadata/commit/6031911793e8abcccbafcc1190c673793985ee4d))
* **index:** add CORS headers to manifest.json endpoints to prevent browser blocking ([d0cda45](https://github.com/0xConstant1/aiometadata/commit/d0cda456a468ebdf756218cfc6992a2cc496503f))
* **kitsu:** avoid using unreliable TMDB fallbacks for franchise fallback mappings; use background for upcoming episode thumbnails; ([ad91a43](https://github.com/0xConstant1/aiometadata/commit/ad91a43cf5d4f0033b5cb1c6d1b52d3825bd7c6c))
* **kitsu:** fix language fallback logic ([af1972e](https://github.com/0xConstant1/aiometadata/commit/af1972e915e2c3ed2adfc386e4ec24d49e3109e8))
* lbox id extraction ([807d483](https://github.com/0xConstant1/aiometadata/commit/807d4833f98ff14d0a6ed52224b80751b5485cc7))
* lbox id extraction ([f566a1a](https://github.com/0xConstant1/aiometadata/commit/f566a1ad89c70b095effe6c36bb680a64f4b4b07))
* **letterboxd:** fix error when letterboxd would return type show for series ([f1ce58c](https://github.com/0xConstant1/aiometadata/commit/f1ce58c726376d1358410c7e869b97d250f6faab))
* make persons search strict ([02cf696](https://github.com/0xConstant1/aiometadata/commit/02cf69696478dfeb7d93ee8c7e60bcbc0edf0053))
* make persons search strict ([4d253b2](https://github.com/0xConstant1/aiometadata/commit/4d253b25b6f367b5f4c7909ca5040bd009b120b2))
* make skygo region agnostic ([ca8c08c](https://github.com/0xConstant1/aiometadata/commit/ca8c08cb0eddba3b8a3b12bb5958809a4dbe8c23))
* **mal cache warming:** resolve issue with genre value not matching index call when show in home is false for MAL, TVDB & TVMaze catalogs ([debbefd](https://github.com/0xConstant1/aiometadata/commit/debbefd89ae5ca8638af52a3228c684092cd3400))
* **manifest:** make id generation more unique to fix edge cases with display types ([aee5a5b](https://github.com/0xConstant1/aiometadata/commit/aee5a5b5537d81f2f13a8ba53454f41c57a9ce8d))
* **mdblist:** correct unified watchlist response parsing ([eb277b0](https://github.com/0xConstant1/aiometadata/commit/eb277b04a1348ac4c25bd9232b60c0242bdbd988))
* **mdblist:** fix import by list url ([2778c7a](https://github.com/0xConstant1/aiometadata/commit/2778c7ad9043e6b773f6a9c484755b6edf816fae))
* **mdblist:** fix list type assignement when adding lists via username ([136a477](https://github.com/0xConstant1/aiometadata/commit/136a4779bb86326d8339294fb2b0bc1131d4ecb1))
* **mdblist:** implement a per key rate limiter to avoid global cooldown ([f1ce58c](https://github.com/0xConstant1/aiometadata/commit/f1ce58c726376d1358410c7e869b97d250f6faab))
* **mdblist:** missing validation condition ([812d6be](https://github.com/0xConstant1/aiometadata/commit/812d6be080746e3dd5358edf67b8d530aa2f8cc9))
* **mdblist:** pass unified paramater to query for mixed lists so that order is kept ([2778c7a](https://github.com/0xConstant1/aiometadata/commit/2778c7ad9043e6b773f6a9c484755b6edf816fae))
* **mdblist:** prioritize list slug for url generation ([c15b5d1](https://github.com/0xConstant1/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* **mdblist:** type guard response.headers and extend rateLimitState for new rate limit headers ([19ba774](https://github.com/0xConstant1/aiometadata/commit/19ba774754bcf5ec4550e8a181568b677a014d1e))
* **meta:** fix anime id condition issue ([9a22e0e](https://github.com/0xConstant1/aiometadata/commit/9a22e0e8ce3b9bdfead2ac53ddae77f9958a3986))
* **meta:** fix undefined certificationsData and empty ids handling ([7c66530](https://github.com/0xConstant1/aiometadata/commit/7c665305d9322e92959bcdd15d62948218729a5e))
* **meta:** move IMDB logo fallback outside includeVideos block in buildTvdbSeriesResponse ([eb277b0](https://github.com/0xConstant1/aiometadata/commit/eb277b04a1348ac4c25bd9232b60c0242bdbd988))
* **meta:** prevent getMeta from being called if imdb id isnt found when Use IMDb ID for Catalog/Search for Series is On ([f566121](https://github.com/0xConstant1/aiometadata/commit/f566121f768e2c9787d8e38182c733f268b40074))
* **meta:** strip upnext/unwatched/tun prefixes before rebuilding RPDB proxy URL ([7dd2692](https://github.com/0xConstant1/aiometadata/commit/7dd26927a571b3a8c13edc019d7c015d42ead54c))
* multiple search and thumbnail improvements ([bd904ad](https://github.com/0xConstant1/aiometadata/commit/bd904ad7b208572779b359d460e024b9d26e6ddc))
* prevent unbounded growth on cacheHealth metrics ([a914290](https://github.com/0xConstant1/aiometadata/commit/a91429064cff243817b3d61001eb7f65bee681ca))
* prioritize background over season poster for unaired episode thumbnails ([04df2b0](https://github.com/0xConstant1/aiometadata/commit/04df2b06c6862eada3ac57cb1ab5483e5b67e33b))
* proxy frontend Trakt calls through backend rate limiter ([17d80b7](https://github.com/0xConstant1/aiometadata/commit/17d80b7e71ef75a44cc52809cb8b7bd29aaa77fd))
* remove reservoir from bottleneck ([5364249](https://github.com/0xConstant1/aiometadata/commit/536424916236e273c2b2b0998abc201472287fa4))
* rename searches instead of providers for independent naming ([bd904ad](https://github.com/0xConstant1/aiometadata/commit/bd904ad7b208572779b359d460e024b9d26e6ddc))
* resolve cache poisoning and improve anime detection ([fdde48e](https://github.com/0xConstant1/aiometadata/commit/fdde48e7e5c7ded538eb9641e2910bb68905ce94))
* revert bottleneck implementation ([9b4f186](https://github.com/0xConstant1/aiometadata/commit/9b4f1863746a9ff164e662cf7de4096b053f206e))
* **search:** fix digital release filter not being correctly disabled for search only ([fa17c2f](https://github.com/0xConstant1/aiometadata/commit/fa17c2fee361021d00e4e102c53819dde7006a88))
* **search:** Improve search provider labeling ([c22ee47](https://github.com/0xConstant1/aiometadata/commit/c22ee47afae5dbe946ab85632b609a6b1b956d19))
* **search:** show TVDB search in dropdown with API key required indicator ([2a0eaa5](https://github.com/0xConstant1/aiometadata/commit/2a0eaa5ab03723294aea797e14500b141e909fd5))
* **simkl:** use empty string and 0 instead of null for refresh_token and expires_at ([7bbe929](https://github.com/0xConstant1/aiometadata/commit/7bbe9291229dd416d34097e9a00f60f23ff86a80))
* **streaming catalogs - paramount:** update provider id ([f11467f](https://github.com/0xConstant1/aiometadata/commit/f11467fb710653d7e379d23cd686e6b13054aa76))
* **streaming catalogs:** resolve issue with some providers showing few items ([47bc793](https://github.com/0xConstant1/aiometadata/commit/47bc793f9f0924a784409332a3b8c460866f55f8))
* sync AI toggle when disabling AI search in sortable list ([bd904ad](https://github.com/0xConstant1/aiometadata/commit/bd904ad7b208572779b359d460e024b9d26e6ddc))
* tmdb auth flow ([ff7aba4](https://github.com/0xConstant1/aiometadata/commit/ff7aba41bb3ffbbfbcd92729861ca1bdc29011fe))
* **tmdb meta:** Use original_title when user language matches original language and no translation exists ([56ff1e1](https://github.com/0xConstant1/aiometadata/commit/56ff1e1975d2cf7621c05dc06a93b25e20d01303))
* **tmdb top rated:** increase vote count to filter trash out ([a4b84c9](https://github.com/0xConstant1/aiometadata/commit/a4b84c928e335140de9219dce69ba3a0df77d856))
* **tmdb trailers:** fix multilingual trailers logic ([cc4a088](https://github.com/0xConstant1/aiometadata/commit/cc4a088ad7a98b5d8e98a926ccfd6c3cd4eda4b0))
* **TOP Posters:** fix top rating posters still showing in library when Keep Rating Posters for Library Items was false ([4834d73](https://github.com/0xConstant1/aiometadata/commit/4834d73161b11fbc0647def35b3abeb1d35d2c38))
* **top rating:** use the correct endpoint for api key testing ([6ef0c70](https://github.com/0xConstant1/aiometadata/commit/6ef0c7099a226b30de0369b6e29844297f3b07bf))
* **TOP:** fix AI search not using TOP Posters API ([47a253e](https://github.com/0xConstant1/aiometadata/commit/47a253e4d049612435c4d99c9dbd868aed17100f))
* **trakt genres:** show name instead of slug in stremio ([1f0cf69](https://github.com/0xConstant1/aiometadata/commit/1f0cf697b632e87135f736525793c10113028994))
* trakt refresh token logic ([0f37952](https://github.com/0xConstant1/aiometadata/commit/0f379521397570c9b7b195945f4dfce97008e5a9))
* trakt refresh token logic ([e79b3a6](https://github.com/0xConstant1/aiometadata/commit/e79b3a62e02cf38106f98ce637feaf3d49f4b22e))
* trakt token update logic ([4d0aea1](https://github.com/0xConstant1/aiometadata/commit/4d0aea154a79450430855734b3fbfbf003016980))
* trakt token update logic ([8af1a4b](https://github.com/0xConstant1/aiometadata/commit/8af1a4b94924d5c225047a0a17e3624961b53cad))
* **trakt ui:** remove trakt secret for integration disabling condition ([b7a7b5d](https://github.com/0xConstant1/aiometadata/commit/b7a7b5d7f6cfe4fa64af1d42d804637b057ad2b1))
* **trakt up next:** fix issue with caching ([b44be7c](https://github.com/0xConstant1/aiometadata/commit/b44be7c81bad2bd6c7550b8cea63ec8d8678dd01))
* **trakt:** add deselect all buttons for multi-select lists ([02c250d](https://github.com/0xConstant1/aiometadata/commit/02c250d6a530ae5370315d28eb10524aa7529156))
* **trakt:** convert token expiry to string for postgres users ([812d6be](https://github.com/0xConstant1/aiometadata/commit/812d6be080746e3dd5358edf67b8d530aa2f8cc9))
* **trakt:** Filter dropped shows from Trakt Up Next and Recently Aired catalogs ([9cea060](https://github.com/0xConstant1/aiometadata/commit/9cea060b61b62a0129baa723917ecba819d38fe3))
* **trakt:** fix sort direction parameter not being sent to API requests ([02c250d](https://github.com/0xConstant1/aiometadata/commit/02c250d6a530ae5370315d28eb10524aa7529156))
* **Trakt:** fix Trakt OAuth 301 redirect error ([afe6e26](https://github.com/0xConstant1/aiometadata/commit/afe6e269a6dd7827482612f38df4727dd2fdf545))
* **trakt:** prevent trending/popular list stacking in UI ([02c250d](https://github.com/0xConstant1/aiometadata/commit/02c250d6a530ae5370315d28eb10524aa7529156))
* **trakt:** reduce retries for individual show fetches in Up Next ([d1037bd](https://github.com/0xConstant1/aiometadata/commit/d1037bd62d8a39e9f9d62742a2817d393b8fd764))
* **trakt:** support official lists with null user slug ([f681857](https://github.com/0xConstant1/aiometadata/commit/f681857b6d4ca242b221eff90b4b5d536d1369be))
* treat 500 as retryable ([dcb1376](https://github.com/0xConstant1/aiometadata/commit/dcb13760dccb0573b6e92e78d8a0049ca18ef2b9))
* treat 500 as retryable ([7a5fbb6](https://github.com/0xConstant1/aiometadata/commit/7a5fbb69b1c68773f353d2cac71997f91e74618a))
* TVDB collections movies-only, TVMaze schedule improvements ([c47746a](https://github.com/0xConstant1/aiometadata/commit/c47746ab4c451eb1cf94357d79e69e0ae7df9656))
* tvdb episode fetching error ([2a52d5f](https://github.com/0xConstant1/aiometadata/commit/2a52d5fa62667ee9820058bd3c8a9d1621f37be4))
* **tvdb genre:** TVDB genres pagination by using correct pageSize from env var ([1fef78e](https://github.com/0xConstant1/aiometadata/commit/1fef78e467d24a54543d98f4a92d6644620b66fa))
* **tvdb trending:** improve tvdb trending fetching logic ([f574204](https://github.com/0xConstant1/aiometadata/commit/f5742045d3bd02e16d19eee300aa048d446823ab))
* **tvdb:** convert years to season numbers for shows that use season years as season numbers ([9bf0803](https://github.com/0xConstant1/aiometadata/commit/9bf0803db3e9368f76f770e5d805daf991da3a1f))
* TVmaze rate limiting ([98471d7](https://github.com/0xConstant1/aiometadata/commit/98471d736508d670ee431c7d8d199c046bd8df44))
* **tvmaze:** Update schedule API from web to full and adapt new response structure ([27cbacd](https://github.com/0xConstant1/aiometadata/commit/27cbacd21b1651335fa89659b92f349250104810))
* **ui:** hide cache ttl option and settings gear for simkl watchlist ([c15b5d1](https://github.com/0xConstant1/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* **UI:** make sure Enable Gemini search is disabled AND toggled off when no api key is entered ([4834d73](https://github.com/0xConstant1/aiometadata/commit/4834d73161b11fbc0647def35b3abeb1d35d2c38))
* **up next:** Exclude episodes without air date from Trakt Up Next and exclude MDBList Up Next from catalog warmer ([1915305](https://github.com/0xConstant1/aiometadata/commit/191530582b4fb06f491a24d08faa27634615661a))
* **up next:** invalidate meta cache via ep number ([5765133](https://github.com/0xConstant1/aiometadata/commit/57651331dec2f8843680719ad5bdd0634b45c4f0))
* **up next:** prevent rpdb from applying to thumbnails ([fa17c2f](https://github.com/0xConstant1/aiometadata/commit/fa17c2fee361021d00e4e102c53819dde7006a88))
* update anilist label ([83e94e5](https://github.com/0xConstant1/aiometadata/commit/83e94e51f300d4861f7bd13c9d5dbffefc504d02))
* update anilist label ([f6342c2](https://github.com/0xConstant1/aiometadata/commit/f6342c2bed6d471cc42bc6657ee291beab03a422))
* update redis memory calculation in cache management UI element ([537b918](https://github.com/0xConstant1/aiometadata/commit/537b91839d7aaf966ceaabe95f3ab62ff8b5aa56))
* update redis memory calculation in cache management UI element ([59d964e](https://github.com/0xConstant1/aiometadata/commit/59d964e8fa652f76d4ac4187a69675426a524337))
* use AniList format field to determine movie vs series ([ffb3051](https://github.com/0xConstant1/aiometadata/commit/ffb305184d4e90e7b949bc29e4d9b54a1b1afa2b))
* use mdblistType instead of type ([63ce8fc](https://github.com/0xConstant1/aiometadata/commit/63ce8fca67ea4575870aff5e8ec941997f927725))
* use mdblistType instead of type ([85295b0](https://github.com/0xConstant1/aiometadata/commit/85295b0282293f8a6d532f77d6b3b71318981759))
* use retry-after header for trakt ([9908807](https://github.com/0xConstant1/aiometadata/commit/9908807aaee8b47506866877165ed719c9f4f596))
* use retry-after header for trakt ([0065151](https://github.com/0xConstant1/aiometadata/commit/006515173a1fda4598019f16c957d651b41a9d77))
* use retry-after header for tvmaze ([b474656](https://github.com/0xConstant1/aiometadata/commit/b4746567e27fbce9b42010b42e4c5fc2e7a81097))
* use unified true for MDBList lists imported via username ([a5e10dd](https://github.com/0xConstant1/aiometadata/commit/a5e10dd92d9950cb979353b6a76299a67b0a0927))
* **user management:** resolve issue with password reset ([4be921a](https://github.com/0xConstant1/aiometadata/commit/4be921abc54654e83766a90f10ad7d68e8cb3bec))
* **warming:** resolve issue with kitsu ids reverting to imdb id ([9fe3ddf](https://github.com/0xConstant1/aiometadata/commit/9fe3ddf7f45b96b75b43d3e6eee1f8cf35e9ac76))
* **wiki:** HTTP 429 error handling in wiki-mapper with retry logic and cache fallback ([62c010a](https://github.com/0xConstant1/aiometadata/commit/62c010a855664bd70b51a0847ff0a678889267e6))


### Performance Improvements

* add config cache stampede protection and increase TTL ([ff36d79](https://github.com/0xConstant1/aiometadata/commit/ff36d79f5e90ea6f4aed981245f515d91f175cd8))
* add in-memory config cache ([f0f2a59](https://github.com/0xConstant1/aiometadata/commit/f0f2a5918494105af65c039f6c46ee8a2eef14de))
* cache-wrap TMDB API methods for better performance ([fbbd6bc](https://github.com/0xConstant1/aiometadata/commit/fbbd6bcbe9844954d64d161cc9cc2fc1e432cfe1))
* **cache:** refactor redis cache cleanup to use SCAN ([c15b5d1](https://github.com/0xConstant1/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* compile regex pattern once ([19272a7](https://github.com/0xConstant1/aiometadata/commit/19272a75a69f2c6d9d2d11d7dcb10cd169f6063e))
* improve MAL/Jikan API request handling and caching ([54a0c85](https://github.com/0xConstant1/aiometadata/commit/54a0c8569ffa907b89d23e8ab6003c9e204be9e7))
* Optimize anime ID lookups from O(N) to O(1) ([c306a86](https://github.com/0xConstant1/aiometadata/commit/c306a86d7da47d2d75330c0e1a7807d53c81cd20))
* parallelize calls in parseProps.js ([820e3c9](https://github.com/0xConstant1/aiometadata/commit/820e3c99c49f67710415e299315937673d58d39a))
* parallelize tracking operations ([829d896](https://github.com/0xConstant1/aiometadata/commit/829d896ee59315cb3aa8d1c908e1f574c7e3f5cb))
* pre-compute langCode3 once and re-use ([6d0e31d](https://github.com/0xConstant1/aiometadata/commit/6d0e31d6a3024d8cb858366fe253b56e2c1b8d0f))
* **request-tracker:** make tracking calls non-blocking ([472dacd](https://github.com/0xConstant1/aiometadata/commit/472dacdd720832d94112c816a243d3b248f9c40d))
* simplify and parallelize requestTracker further ([0839d65](https://github.com/0xConstant1/aiometadata/commit/0839d65bf1e3f8bd04f2ac2cf594a97aae772239))
* **timing-metrics:** use Redis pipeline and fire-and-forget pattern ([e056b7b](https://github.com/0xConstant1/aiometadata/commit/e056b7b842c25c5efcc30ca5a42f18e5ce7bfe60))
* **tmdb:** optimize request handling and rate limiting ([af1972e](https://github.com/0xConstant1/aiometadata/commit/af1972e915e2c3ed2adfc386e4ec24d49e3109e8))
* use MGET in reconstructMetaFromComponents ([f7e58e1](https://github.com/0xConstant1/aiometadata/commit/f7e58e1e82aaf38d996284ead538678e15d69a4e))
* use redis pipeline for requestTracker.js ([3dd4e8f](https://github.com/0xConstant1/aiometadata/commit/3dd4e8fe60729dbc4a7cbb28365d85971eea5e5e))
* **wiki-mapper:** convert lookup functions to synchronous ([ea648e3](https://github.com/0xConstant1/aiometadata/commit/ea648e3476a9d3b2cf117ce9a7e67b2feeb3c675))


### Reverts

* discard getMeta.js changes from PR 181 ([3dd7ddf](https://github.com/0xConstant1/aiometadata/commit/3dd7ddfef51cdd54f15f7538f22001b85fa56cee))
* temporarily revert to fribbs previous list update containing imdb ids ([a980fe1](https://github.com/0xConstant1/aiometadata/commit/a980fe16d770286b0a25af1d58bb73050ce7c2e8))
